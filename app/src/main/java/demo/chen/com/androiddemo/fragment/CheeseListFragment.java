...
package demo.chen.com.androiddemo.fragment;
...
import demo.chen.com.androiddemo.activity.CheeseDetailActivity;
import demo.chen.com.androiddemo.base.BaseItem;
import demo.chen.com.androiddemo.base.Cheeses;
...
public class CheeseListFragment extends Fragment {
    ...
    public void setupRecyclerView(List<BaseItem> data) {
    ...
    public static class SimpleStringRecyclerViewAdapter
        ...
        public BaseItem getValueAt(int position) {
            return mValues.get(position);
        }

        public SimpleStringRecyclerViewAdapter(Context context, List<BaseItem> items) {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, mValues.get(position).getItemClass());
